 ...
 *
 * - If set to "false" or "0", disables fetching and uses fallback data (no files created)
 * - If set to "true", "1", or not set, uses the default behavior (fetches and caches cf.json)
 *
